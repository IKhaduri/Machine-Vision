...
%       the testImg face
    ...
    if strcmp(method,'simple')
        ...
        % will be helpful.
        [~ ,indexOfClosestMatch] = indexOfClosestColumn(A,unrolled);
    ...
    elseif strcmp(method,'eigenface')
        ...
        [~, indexOfClosestMatch] = indexOfClosestColumn(weightCols, w);
...
%   Euclidean distance to testColumn.
    ...
    [minDist, indexOfClosest] = pdist2(A',testColumn','euclidean','Smallest',1);
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %                                                                     %
    %                            END YOUR CODE                            %
    %                                                                     %
